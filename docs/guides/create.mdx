...
- [**RewardWeight**](../concepts/staking.mdx): Specifies the ratio of [reward power](../concepts/staking.mdx#reward-weight) given to each Alliance asset. A chain's native asset assumes a reward weight of 1.  
