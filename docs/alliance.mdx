...
Other After being approved, the assets become Alliance assets, which can be staked by users to start earning rewards. For more information on adding Alliance assets, visit the [Alliance creation guide](./guides/create.mdx)
