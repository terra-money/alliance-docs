...
| Score | Task                                                                                | Tip                                                                                 |
| ----- | ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| 1     | Delegate to any validators using the alliance module                                | [How to delegate tokens](./how-to-stake#delegate-tokens-to-your-preferred-alliance) |
| 1     | Redelegate to any validators using the alliance module                              |                                                                                     |
| 1     | Undelegate from any validators using the alliance module                            | [How to undelegate](./how-to-restake)                                               |
| 1     | Claim rewards from a chain                                                          |                                                                                     |
| 5     | Undelegate from one chain and delegate to different chain at least 10 times         | [How to redelegate](./how-to-restake)                                               |
...
| 1     | Submit constructive feedback through Github Issues/Google form                      |                                                                                     |
...
Navigate to the [Interchain staking with Alliance](./how-to-stake) tutorial, which will guide you through how to:
...
The [Undelegating and restaking](./how-to-restake) tutorial walks you through how to undelegate your stake, transfer the undelegated tokens to another chain, and restake the tokens to take advantage of higher cross-chain rewards.
