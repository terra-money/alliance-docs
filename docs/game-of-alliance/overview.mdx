...
2. Strategically delegate, undelegate, and redelegate tokens across multiple chains in order to maximize your rewards and complete tasks.
3. Claim rewards and receive prizes!

Tasks available for completion by participants and their corresponding scores are shown below.

| Score | Task                                                                                | Instructions                                                             |
| ----- | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| 1     | Delegate to any validators using the alliance module                                | [How to delegate](delegating#delegate-tokens-to-your-preferred-alliance) |
| 1     | Redelegate to any validators using the alliance module                              | [How to redelegate](./redelegating)                                      |
| 1     | Undelegate from any validators using the alliance module                            | [How to undelegate](./cross-chain-redelegating#undelegate-staked-tokens) |
| 1     | Claim rewards from a chain                                                          | [How to claim rewards](./delegating#claim-rewards)                       |
| 5     | Undelegate from one chain and delegate to different chain at least 10 times         | [How to redelegate cross-chain](./cross-chain-redelegating)              |
...
Navigate to the [Interchain staking with Alliance](./delegating) tutorial, which will guide you through how to:
...
The [Undelegating and restaking](./redelegating) tutorial walks you through how to undelegate your stake, transfer the undelegated tokens to another chain, and restake the tokens to take advantage of higher cross-chain rewards.
