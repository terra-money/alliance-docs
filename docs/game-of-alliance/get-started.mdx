...
# Start playing the Game of Alliance

The Game of Alliance is a three-week competition designed to battle-test the Alliance module ahead of its mainnet release. To learn more about the rules for the game, visit the [Overview page](./overview.mdx). In this tutorial, you will learn how to transfer your assets from one chain to another and use those funds in order to stake to a validator on the new chain.

## Create a new Station wallet

1. Follow the [Station extention download guide](https://docs.terra.money/learn/station/download/station-extension) to make sure that you have the newest version of the Station extension. 
...
Wallets that use the faucet more than once will not be eligible for the Game of Alliance airdrop. 
