...
To redelegate your tokens from one validator to another on the same chain, follow the steps in the [Redelegate tokens](./redelegate.mdx) section.

</Admonition>

Referring to the diagram below, if we want to move from Chain 1 to Chain 3 in testnet, we will first need to transfer tokens from Chain 1 to Terra testnet (Pisco-1) then from Terra testnet (Pisco-1) to Chain 3.
...
7. Now, you can navigate to the [Game of Alliance staking page](https://game-of-alliance.pages.dev/staking) to delegate. You can refer to the [Delegate tokens to your preferred Alliance](./get-started.mdx#delegate-tokens-to-your-preferred-alliance) section to follow the steps to stake your asset.
