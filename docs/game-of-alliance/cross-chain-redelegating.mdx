...
In this example, you will walk through the steps of transferring assets from one chain to another, 
...
2. Undelegate the asset that you want to transfer to another chain.

<img className="readme-img-sm" src="/img/goa/cross-2.png" />

<Admonition type="info" icon="ℹ️" title="Unbonding period">

In the Game of Alliance, the unbonding period is 1 hour. 
