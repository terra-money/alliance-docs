...
# Interchain staking with Alliance
...
Follow the [Station extention guide](https://docs.terra.money/learn/station/download/station-extension) to make sure that you have the newest version of the Station extension and create a new wallet to follow along with this tutorial.
