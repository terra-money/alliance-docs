...
The [Game of Alliance](../game-of-alliance/overview.mdx) testnet consists of four chains `ordos`, `corrino`, `harkonnen` and `atreides`.

## Instructions

Specifically for validators, the following instructions will let you participate in the testnet chain of your choosing.

These are the Chain-IDs, native Denoms, and executable:
...
2. Visit the faucet: https://game-of-alliance.terra.money/faucet
