...
The Game of Alliance ended on March 2nd, 2023. This page was for GoA validators, and is for reference only. 
...
Specifically for validators, the following instructions will let you participate in the testnet.
